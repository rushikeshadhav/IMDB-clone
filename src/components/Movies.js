...
function Movies() {
    ...
    return <>
        <div className="mb-8 text-center">
            <div className="mt-8 mb-8 text-teal-500 font-bold text-2xl text-center">Trending Movies</div>
            {
                movies.length == 0 ?
                    ...
                    <div className="flex flex-wrap justify-center">
                        {
                            movies.map((movie) => (
                                ...
                                >
                                    ...
                                    <div className="w-full bg-gray-900 bg-teal-400 py-2 font-bold text-center rounded-b-xl">{movie.title} </div>
                                </div>
                            ))
                        }
